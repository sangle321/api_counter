...
class Detector(object):
    def __init__(self, path_config, path_ckpt, path_to_labels, nms_threshold=0.15, score_threshold=0.3):
    ...
    def draw(self, img):
        ...
        for i, score in enumerate(self.detection_scores):
            ...
            list_location.append({"locations":coordinate_dict[label], "confidence": str(round(score, 2))})
        return img, list_location
